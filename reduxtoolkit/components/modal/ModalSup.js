...
export const ModalSup = ({ visible, onClose, onHide, handleSubmit }) => {
  return (
    <Modal
      visible={visible}
      animationType="fade"
      ...
      <TouchableWithoutFeedback onPress={onHide}>
        <View style={styles.containerPost}>
          <View style={styles.modalContainerPost}>
            ...
            <Feather style={{textAlign:"center"}} name="alert-circle" size={50} color="red" />
              <Text
                style={{
                  color: "black",
              ...
              >
                {" "}
                êtes-vous sûr de vouloir supprimer ce {"\n"} membre définitivement ?{" "}
              </Text>

             
              <View style={styles.buttonView}>
              <TouchableOpacity style={styles.buttonSup} onPress={handleSubmit}>
                <Text style={styles.textbutton}>Supprimer</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.buttonAnnuler} onPress={onClose}>
