  ...
  return (
    <ScrollView>
      <View style={styles.head}>
        <Text style={styles.texthead}>Ajouter poste</Text>
      </View>
      <View style={styles.mespub}>
        <Text
          style={styles.textmp}
          onPress={() => navigation.navigate("mesPub")}
        >
          Mes publications
        </Text>
      </View>
      ...
      <View style={styles.sub}>
        <TouchableOpacity style={styles.icons} onPress={selectImage}>
          <Text style={styles.icon}>
            <FontAwesome name="photo" size={28} color="#AF558B" />
          </Text>
          {imageURI && (
            <Image
              source={{ uri: imageURI }}
        ...
        <TouchableOpacity style={styles.button} onPress={addPostSubmit}>
